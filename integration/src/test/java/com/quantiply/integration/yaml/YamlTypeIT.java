...
package com.quantiply.integration.yaml;
...
public class YamlTypeIT {
    ...
    public static void generateAndCompileClass() throws ClassNotFoundException {
        classWithManyTypes = classSchemaRule.generateAndCompile("/schema/yaml/type/types.yaml", "com.example", CodeGenerationHelper.config("sourceType", "yamlschema"))
    ...
    public void maximumGreaterThanIntegerMaxCausesIntegersToBecomeLongs() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
        Class<?> classWithLongProperty = schemaRule.generateAndCompile("/schema/yaml/type/integerWithLongMaximumAsLong.yaml", "com.example", CodeGenerationHelper.config("sourceType", "yamlschema"))
    ...
    public void maximumGreaterThanIntegerMaxCausesIntegersToBecomePrimitiveLongs() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
        Class<?> classWithLongProperty = schemaRule.generateAndCompile("/schema/yaml/type/integerWithLongMaximumAsLong.yaml", "com.example", CodeGenerationHelper.config("usePrimitives", true, "sourceType", "yamlschema"))
                .loadClass("com.example.IntegerWithLongMaximumAsLong");
    ...
    public void minimumLessThanIntegerMinCausesIntegersToBecomeLongs() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
        Class<?> classWithLongProperty = schemaRule.generateAndCompile("/schema/yaml/type/integerWithLongMinimumAsLong.yaml", "com.example", CodeGenerationHelper.config("sourceType", "yamlschema"))
    ...
    public void minimumLessThanIntegerMinCausesIntegersToBecomePrimitiveLongs() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
        Class<?> classWithLongProperty = schemaRule.generateAndCompile("/schema/yaml/type/integerWithLongMinimumAsLong.yaml", "com.example", CodeGenerationHelper.config("usePrimitives", true, "sourceType", "yamlschema"))
                .loadClass("com.example.IntegerWithLongMinimumAsLong");
    ...
    public void useLongIntegersParameterCausesIntegersToBecomeLongs() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
        Class<?> classWithLongProperty = schemaRule.generateAndCompile("/schema/yaml/type/integerAsLong.yaml", "com.example", CodeGenerationHelper.config("useLongIntegers", true, "sourceType", "yamlschema"))
    ...
    public void useLongIntegersParameterCausesPrimitiveIntsToBecomeLongs() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
        Class<?> classWithLongProperty = schemaRule.generateAndCompile("/schema/yaml/type/integerAsLong.yaml", "com.example", CodeGenerationHelper.config("useLongIntegers", true, "usePrimitives", true, "sourceType", "yamlschema"))
                .loadClass("com.example.IntegerAsLong");
    ...
    public void useDoubleNumbersFalseCausesNumbersToBecomeFloats() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
        Class<?> classWithDoubleProperty = schemaRule.generateAndCompile("/schema/yaml/type/numberAsFloat.yaml", "com.example", CodeGenerationHelper.config("useDoubleNumbers", false, "sourceType", "yamlschema"))
    ...
    public void useDoubleNumbersFalseCausesPrimitiveNumbersToBecomeFloats() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
        Class<?> classWithDoubleProperty = schemaRule.generateAndCompile("/schema/yaml/type/numberAsFloat.yaml", "com.example", CodeGenerationHelper.config("useDoubleNumbers", false, "usePrimitives", true, "sourceType", "yamlschema"))
                .loadClass("com.example.NumberAsFloat");

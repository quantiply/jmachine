...
package com.quantiply.integration.util;
...
public class Jsonschema2PojoRuleTest {
    ...
    public static class MethodTests {
        ...
        public void compilationProblemsStdErr() {
            try {
                rule.generateAndCompile("/schema/default/default.json", "com.example", CodeGenerationHelper.config("customRuleFactory", BrokenRuleFactory.class.getName()));
            } catch( Throwable t ) {}
        ...
        public static class BrokenRuleFactory extends RuleFactory {
            @Override
            public com.quantiply.rules.Rule<JPackage, JType> getObjectRule() {
                final com.quantiply.rules.Rule<JPackage, JType> workingRule = super.getObjectRule();

                return new com.quantiply.rules.Rule<JPackage, JType>() {
                    @Override

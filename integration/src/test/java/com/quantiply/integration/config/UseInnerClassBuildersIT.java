...
public class UseInnerClassBuildersIT {
  ...
  public void noBuilderMethodsByDefault() {
    File outputDirectory = schemaRule.generate("/schema.useInnerClassBuilders/child.json", "com.example", CodeGenerationHelper.config());
  ...
  public void defaultBuilderIsChainedSetters() throws ClassNotFoundException {
    ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema.useInnerClassBuilders/child.json", "com.example",
        CodeGenerationHelper.config("generateBuilders", true));
  ...
  public void innerBuildersRemoveChainedSetters() throws ClassNotFoundException {
    ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema.useInnerClassBuilders/child.json", "com.example",
        CodeGenerationHelper.config("generateBuilders", true, "useInnerClassBuilders", true));
  ...
  public void innerBuilderWithAllPropertyConstructor()
    ...
    ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema.useInnerClassBuilders/child.json", "com.example",
        CodeGenerationHelper.config("generateBuilders", true, "useInnerClassBuilders", true, "includeConstructors", true));
  ...
  public void innerBuilderWithRequiredPropertyConstructor()
      throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, InstantiationException {
    ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema.useInnerClassBuilders/child.json", "com.example",
        CodeGenerationHelper.config("generateBuilders", true, "useInnerClassBuilders", true, "includeConstructors", true, "constructorsRequiredPropertiesOnly", true));

...
public class IncludeHashCodeAndEqualsIT {
    ...
    public static void generateAndCompileClass() {
        resultsClassLoader = classSchemaRule.generateAndCompile("/schema/hashCodeAndEquals/types.json", "com.example", CodeGenerationHelper.config("includeAdditionalProperties", false));
    }

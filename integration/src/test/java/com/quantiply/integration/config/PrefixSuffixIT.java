...
public class PrefixSuffixIT {
    ...
    public void customClassPrefix() throws ClassNotFoundException{
        ...
        ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema/properties/primitiveProperties.json", "com.example", CodeGenerationHelper.config("classNamePrefix","Abstract"));
    ...
    public void customClassPrefixExistingClass() throws ClassNotFoundException {
        ...
        ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema/properties/objectPropertiesJavaType.json",
                "com.example", CodeGenerationHelper.config("classNamePrefix", "SomePrefix"));
    ...
    public void customClassSuffix() throws ClassNotFoundException{
        ...
        ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema/properties/primitiveProperties.json", "com.example", CodeGenerationHelper.config("classNameSuffix","Dao"));
    ...
    public void SuffixWithDefaultPackageName() throws ClassNotFoundException{
        ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema/properties/primitiveProperties.json", "", CodeGenerationHelper.config("classNameSuffix","Dao"));
        resultsClassLoader.loadClass("com.example.NotExistingPrimitiveProperties");
    }

    @Test(expected = ClassNotFoundException.class)
    public void PrefixWithDefaultPackageName() throws ClassNotFoundException{
        ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema/properties/primitiveProperties.json", "", CodeGenerationHelper.config("classNamePrefix","Abstract"));
        resultsClassLoader.loadClass("com.example.NotExistingPrimitiveProperties");
    }
    ...
    public void customClassPrefixNoJavaType() throws ClassNotFoundException {
        ...
        ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema/properties/primitivePropertiesNoJavaType.json",
                "com.example", CodeGenerationHelper.config("classNamePrefix","Prefix"));
    ...
    public void customClassSuffixNoJavaType() throws ClassNotFoundException {
        ...
        ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema/properties/primitivePropertiesNoJavaType.json",
                "com.example", CodeGenerationHelper.config("classNameSuffix","Suffix"));
    ...
    public void customClassPrefixAndSuffixNoJavaType() throws ClassNotFoundException {
        ClassLoader resultsClassLoader = schemaRule.generateAndCompile("/schema/properties/primitivePropertiesNoJavaType.json",
                "com.example", CodeGenerationHelper.config("classNamePrefix", "Prefix", "classNameSuffix","Suffix"));

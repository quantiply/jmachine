...
public class IncludeAccessorsPropertiesIT {
    ...
    public static Collection<Object[]> parameters() {
        return Arrays.asList(new Object[][] {
            { PRIMITIVE_JSON, PRIMITIVE_TYPE, CodeGenerationHelper.config() },
            { PRIMITIVE_JSON, PRIMITIVE_TYPE, CodeGenerationHelper.config("useJodaDates", true) },
            { PRIMITIVE_JSON, PRIMITIVE_TYPE, CodeGenerationHelper.config("includeAdditionalProperties", false) }
        });
    }

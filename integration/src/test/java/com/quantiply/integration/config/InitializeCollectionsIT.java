...
public class InitializeCollectionsIT {
    ...
    public static Collection<Object[]> parameters() {
        Map<String, Object> withOptionFalse = CodeGenerationHelper.config("initializeCollections", false);
        Map<String, Object> withOptionAbsent = CodeGenerationHelper.config();

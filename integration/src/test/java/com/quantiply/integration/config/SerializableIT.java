...
public class SerializableIT {
    ...
    public void beansDoNotIncludeSerializableByDefault() throws ClassNotFoundException, SecurityException {
        ...
        ClassLoader resultsClassLoader = CodeGenerationHelper.generateAndCompile("/schema/properties/primitiveProperties.json", "com.example");
    ...
    public void beansIncludeSerializableWhenConfigIsSet() throws ClassNotFoundException, SecurityException {
        ClassLoader resultsClassLoader = CodeGenerationHelper.generateAndCompile("/schema/properties/primitiveProperties.json", "com.example", CodeGenerationHelper.config("serializable", true));
    ...
    public void beansCanIncludeConstructor() throws ClassNotFoundException, SecurityException {
        ClassLoader resultsClassLoader = CodeGenerationHelper.generateAndCompile("/schema/properties/primitiveProperties.json", "com.example", CodeGenerationHelper.config("serializable", true, "includeConstructors", true));

...
jsonSchema2Pojo {
  ...
  Annotatortyle. If you want to use the custom annotator alone, set annotationStyle to none.
  customAnnotator = 'NoopAnnotator'

  //NoopAnnotatorotations (for schema rules like minimum, maximum, etc) in

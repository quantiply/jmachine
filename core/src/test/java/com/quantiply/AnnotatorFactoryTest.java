...
public class AnnotatorFactoryTest {
    ...
    public void canCreateCorrectAnnotatorFromAnnotationStyle() {
        ...
        assertThat(factory.getAnnotator(AnnotationStyle.JACKSON1), is(instanceOf(Jackson1Annotator.class)));
        assertThat(factory.getAnnotator(AnnotationStyle.JACKSON), is(instanceOf(Jackson2Annotator.class)));
        assertThat(factory.getAnnotator(AnnotationStyle.JACKSON2), is(instanceOf(Jackson2Annotator.class)));
        assertThat(factory.getAnnotator(AnnotationStyle.GSON), is(instanceOf(GsonAnnotator.class)));
        assertThat(factory.getAnnotator(AnnotationStyle.MOSHI1), is(instanceOf(Moshi1Annotator.class)));
        assertThat(factory.getAnnotator(AnnotationStyle.NONE), is(instanceOf(NoopAnnotator.class)));

...
import com.quantiply.AllFileFilter;
import com.quantiply.AnnotationStyle;
import com.quantiply.Annotator;
import com.quantiply.GenerationConfig;
import com.quantiply.InclusionLevel;
import com.quantiply.Language;
import com.quantiply.NoopAnnotator;
import com.quantiply.SourceSortOrder;
import com.quantiply.SourceType;
...
public class Arguments implements GenerationConfig {
    ...
    @Parameter(names = { "-A", "--custom-annotator" }, description = "The fully qualified class name of referring to a custom annotator class that implements Annotator " + "and will be used in addition to the --annotation-style. If you want to use a custom annotator alone, set --annotation-style to none", converter = ClassConverter.class)
    private Class<? extends Annotator> customAnnotator = NoopAnnotator.class;

    @Parameter(names = { "-F", "--custom-rule-factory" }, description = "The fully qualified class name of referring to a custom rule factory class that extends RuleFactory " + "to create custom rules for code generation.", converter = ClassConverter.class)
